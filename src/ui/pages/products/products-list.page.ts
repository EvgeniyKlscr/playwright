...
import { ProductDetailsModal } from './details.page';
import { MANUFACTURERS } from 'data/sales-portal/products/manufacturers';
import { DeleteProductsModal } from './delete-products.page';

export class ProductsListPage extends SalesPortalPage {
  readonly detailsModal = new ProductDetailsModal(this.page);
  readonly deleteProductsModal = new DeleteProductsModal(this.page);
